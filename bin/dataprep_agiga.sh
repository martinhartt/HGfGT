...
then
  ...
  python $SCRIPTS/filter.py $WORK/${SMALL}train.data.txt --firstSent 1 --wordOverlap 1 --lengthRange 1 > $WORK/${SMALL}train.data.filter.txt
  python $SCRIPTS/filter.py $WORK/${SMALL}valid.data.txt --firstSent 1 --wordOverlap 1 --lengthRange 1 > $WORK/${SMALL}valid.data.filter.txt
  python $SCRIPTS/filter.py $WORK/${SMALL}test.data.txt --firstSent 1 --wordOverlap 1 --lengthRange 1 > $WORK/${SMALL}test.data.filter.txt
